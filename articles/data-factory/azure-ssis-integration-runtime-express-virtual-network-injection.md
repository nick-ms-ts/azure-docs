...
1. Download a custom setup script main.cmd + its associated file setupdnsserver.ps1 from Azure-DataFactory/SamplesV2/SQLServerIntegrationServices/customScript/SetupCustomDns at main · Azure/Azure-DataFactory.
